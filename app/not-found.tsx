  ...
  return (
    <main id="main-content" className="grid min-h-[70vh] place-items-center px-[var(--gutter)] pt-[var(--header-height)] text-center">
      <div>
        ...
        <DelayedReveal className="mt-5" delay={0.22}>
          <p className="text-[var(--text-secondary)]">Volte à página inicial ou explore nosso catálogo de produtos.</p>
        </DelayedReveal>
        <div className="mt-8 flex flex-wrap justify-center gap-3">
          <Link prefetch={false} className="inline-flex min-h-11 items-center bg-[var(--brand-red)] px-5 font-semibold text-white" href="/">
            Página inicial
          </Link>
          <Link prefetch={false} className="inline-flex min-h-11 items-center border border-[var(--brand-red)] px-5 font-semibold text-[var(--brand-red-dark)]" href="/produtos">
            Ver produtos
          </Link>
        </div>
      </div>
